...
<!-- Preloader -->
        ...
        <div class="mag-main-menu" id="sticker">
            <div class="classy-nav-container breakpoint-off">
                ...
                <nav class="classy-navbar justify-content-between" id="magNav">
                    ...
                    <!-- Nav brand -->
                    <a href="#" class="nav-brand"><img src="Template/img/core-img/logo.png" alt=""></a>
                        ...
                        <div class="classy-menu">
                            ...
                            <div class="classynav">
                                <ul>
                                    ...
                                    <li class="active"><a href="https://www.radios.com.br/aovivo/radio-cuscuz-fm/113194">Rádio</a></li>
                                    <li>
                                        <a href="#">Páginas</a>
                                        <ul class="dropdown">
                                            <li><a href="#">Início</a></li>
                                            <li><a href="https://www.radios.com.br/aovivo/radio-cuscuz-fm/113194">Rádio</a></li>
                        ...
                        <div class="top-meta-data d-flex align-items-center">
                            ...
                            <div class="top-search-area">
                                <form action="#" method="post">
                                    <input type="search" name="top-search" id="topSearch" placeholder="Procurar...">
                                    <button type="submit" class="btn"><i class="fa fa-search" aria-hidden="true"></i></button>
                                </form>
                            </div>
                            <a href="submit-video.html" class="submit-video"><span><i class="fa fa-cloud-upload"></i></span> <span class="video-text">Painel Admin</span></a>
                        </div>
                    </div>
                </nav>
            </div>
    ...
    <div class="hero-area owl-carousel">
        <!-- Single Blog Post -->
        <div class="hero-blog-post bg-img bg-overlay" style="background-image: url(Template/img/bg-img/1.jpg);">
                    ...
                    <div class="col-12">
                        ...
                        <div class="post-content text-center">
                            <div class="post-meta" data-animation="fadeInUp" data-delay="100ms">
                                <a href="#">MAY 8, 2018</a>
                                <a href="~/Template/archive.html">lifestyle</a>
                            </div>
                            <a href="Template/video-post.html" class="post-title" data-animation="fadeInUp" data-delay="300ms">Party Jokes Startling But Unnecessary</a>
                            <a href="Template/video-post.html" class="video-play" data-animation="bounceIn" data-delay="500ms"><i class="fa fa-play"></i></a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!-- Single Blog Post -->
        <div class="hero-blog-post bg-img bg-overlay" style="background-image: url(Template/img/bg-img/2.jpg);">
            <div class="container h-100">
                <div class="row h-100 align-items-center">
                    <div class="col-12">
                        <!-- Post Contetnt -->
        ...
        <!-- Single Blog Post -->
        <div class="hero-blog-post bg-img bg-overlay" style="background-image: url(Template/img/bg-img/3.jpg);">
            <div class="container h-100">
                <div class="row h-100 align-items-center">
                    <div class="col-12">
                        <!-- Post Contetnt -->
    ...
    <section class="mag-posts-area d-flex flex-wrap">
        ...
        <div class="post-sidebar-area left-sidebar mt-30 mb-30 bg-white box-shadow">
            ...
            <div class="single-sidebar-widget">
                <a href="#" class="add-img"><img src="Template/img/bg-img/add.png" alt=""></a>
            </div>
            ...
            <div class="single-sidebar-widget p-30">
                ...
                <div class="single-blog-post d-flex">
                    <div class="post-thumbnail">
                        <img src="Template/img/bg-img/10.jpg" alt="">
                    </div>
                    <div class="post-content">
                        <a href="single-post.html" class="post-title">Choose The Perfect Accommodations</a>
                        <div class="post-meta d-flex justify-content-between">
                ...
                <div class="single-blog-post d-flex">
                    <div class="post-thumbnail">
                        <img src="Template/img/bg-img/11.jpg" alt="">
                    </div>
                    <div class="post-content">
                ...
                <div class="single-blog-post d-flex">
                    <div class="post-thumbnail">
                        <img src="Template/img/bg-img/12.jpg" alt="">
                    </div>
                    <div class="post-content">
            ...
            <div class="trending-now-posts mb-30">
                ...
                <div class="trending-post-slides owl-carousel">
                    ...
                    <div class="single-trending-post">
                        <img src="Template/img/bg-img/19.jpg" alt="">
                        <div class="post-content">
                    ...
                    <!-- Single Trending Post -->
                    <div class="single-trending-post">
                        <img src="Template/img/bg-img/20.jpg" alt="">
                        <div class="post-content">
                    ...
                    <!-- Single Trending Post -->
                    <div class="single-trending-post">
                        <img src="Template/img/bg-img/21.jpg" alt="">
                        <div class="post-content">
                        ...
                        <div class="col-12 col-lg-7">
                            ...
                            <div class="single-featured-post">
                                ...
                                <div class="post-thumbnail mb-50">
                                    <img src="Template/img/bg-img/22.jpg" alt="">
                        ...
                        <div class="col-12 col-lg-5">
                            ...
                            <div class="featured-video-posts-slide owl-carousel">
                                ...
                                <div class="single--slide">
                                    ...
                                    <div class="single-blog-post d-flex style-3">
                                        <div class="post-thumbnail">
                                            <img src="Template/img/bg-img/24.jpg" alt="">
                                        </div>
                                        <div class="post-content">
                                            <a href="single-post.html" class="post-title">A Guide To Rocky Mountain Vacations</a>
                                            <div class="post-meta d-flex">
                                    ...
                                    <div class="single-blog-post d-flex style-3">
                                        <div class="post-thumbnail">
                                            <img src="Template/img/bg-img/26.jpg" alt="">
                                        </div>
                                        <div class="post-content">
                                    ...
                                    <div class="single-blog-post d-flex style-3">
                                        <div class="post-thumbnail">
                                            <img src="Template/img/bg-img/27.jpg" alt="">
                                        </div>
                                        <div class="post-content">
            ...
            <div class="most-viewed-videos mb-30">
                ...
                <div class="most-viewed-videos-slide owl-carousel">
                    ...
                    <div class="single-blog-post style-4">
                        <div class="post-thumbnail">
                            <img src="Template/img/bg-img/28.jpg" alt="">
                            <a href="video-post.html" class="video-play"><i class="fa fa-play"></i></a>
                    ...
                    <div class="single-blog-post style-4">
                        <div class="post-thumbnail">
                            <img src="Template/img/bg-img/30.jpg" alt="">
                            <a href="video-post.html" class="video-play"><i class="fa fa-play"></i></a>
                            <span class="video-duration">09:27</span>
                        </div>
                        <div class="post-content">
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-lg-6">
                        <div class="single-blog-post d-flex style-3 mb-30">
                            <div class="post-thumbnail">
                                <img src="Template/img/bg-img/31.jpg" alt="">
                            </div>
                            <div class="post-content">
                                <a href="single-post.html" class="post-title">From Wetlands To Canals And Dams Amsterdam Is Alive</a>
                                <div class="post-meta d-flex">
                    ...
                    <div class="col-12 col-lg-6">
                        <div class="single-blog-post d-flex style-3 mb-30">
                            <div class="post-thumbnail">
                                <img src="Template/img/bg-img/32.jpg" alt="">
                            </div>
                            <div class="post-content">
                                <a href="single-post.html" class="post-title">From Wetlands To Canals And Dams Amsterdam Is Alive</a>
                                <div class="post-meta d-flex">
                    ...
                    <div class="col-12 col-lg-6">
                        <div class="single-blog-post d-flex style-3 mb-30">
                            <div class="post-thumbnail">
                                <img src="Template/img/bg-img/33.jpg" alt="">
                            </div>
                            <div class="post-content">
                                <a href="single-post.html" class="post-title">From Wetlands To Canals And Dams Amsterdam Is Alive</a>
                                <div class="post-meta d-flex">
                    ...
                    <div class="col-12 col-lg-6">
                        <div class="single-blog-post d-flex style-3 mb-30">
                            <div class="post-thumbnail">
                                <img src="Template/img/bg-img/34.jpg" alt="">
                            </div>
                            <div class="post-content">
                                <a href="single-post.html" class="post-title">From Wetlands To Canals And Dams Amsterdam Is Alive</a>
                                <div class="post-meta d-flex">
        ...
        <div class="post-sidebar-area right-sidebar mt-30 mb-30 box-shadow">
            ...
            <!-- Sidebar Widget -->
            <div class="single-sidebar-widget">
                <a href="#" class="add-img"><img src="Template/img/bg-img/add2.png" alt=""></a>
            </div>
            ...
            <div class="single-sidebar-widget p-30">
                ...
                <div class="single-youtube-channel d-flex">
                    <div class="youtube-channel-thumbnail">
                        <img src="Template/img/bg-img/16.jpg" alt="">
                    </div>
                    <div class="youtube-channel-content">
                ...
                <div class="single-youtube-channel d-flex">
                    <div class="youtube-channel-thumbnail">
                        <img src="Template/img/bg-img/17.jpg" alt="">
                    </div>
                    <div class="youtube-channel-content">
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="footer-widget">
                        <!-- Logo -->
                        <a href="#" class="foo-logo"><img src="Template/img/core-img/logo2.png" alt=""></a>
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="footer-widget">
                        <h6 class="widget-title">Videos do Esporte</h6>
                        <!-- Single Blog Post -->
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="footer-widget">
                        <h6 class="widget-title">Canais</h6>
                        <ul class="footer-tags">
                            ...
                            <li><a href="#">Shows de TV</a></li>
                            <li><a href="#">Twitter Videos</a></li>
                    ...
                    <div class="col-12 col-sm-6">
                        <nav class="footer-nav">
                            <ul>
                                ...
                                <li><a href="https://www.radios.com.br/aovivo/radio-cuscuz-fm/113194">Rádio Cuscuz FM</a></li>
                                <li><a href="#">Contato</a></li>
                            </ul>
                        </nav>
                    </div>
